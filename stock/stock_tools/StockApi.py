        ...
        if df is not None:
            ...
            df.rename(
                columns={
                    ...
                    'open': self.stock_csv_columns_dict['开盘价'],
                    'high': self.stock_csv_columns_dict['最高价'],
                    'low': self.stock_csv_columns_dict['最低价'],
                    'close': self.stock_csv_columns_dict['收盘价'],
                    'code': self.stock_csv_columns_dict['股票代码'],
                    'trade_date': self.stock_csv_columns_dict['交易时间'],
                    'volume': self.stock_csv_columns_dict['成交量'],
                }, inplace=True)
